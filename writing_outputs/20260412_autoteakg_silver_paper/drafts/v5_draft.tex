...
\begin{tabular}{p{0.16\linewidth}p{0.18\linewidth}p{0.24\linewidth}p{0.18\linewidth}p{0.13\linewidth}}
\toprule
Record & Tea/component & Mechanism or path & Metabolite / phenotype & Evidence \\
\midrule
PMID\_41899489\_GLM1 & black tea; polysaccharides & gut-liver axis; macrophage M2 shift & butyric acid; reduced liver inflammation & preclinical; low \\
PMID\_41899489\_GLM2 & black tea; polysaccharides & microbiota production of butyric acid & butyric acid & preclinical; low \\
PMID\_41475763\_GLM1 & tea; polysaccharides & enrichment of SCFA producers & butyrate, acetate, propionate; reduced hepatic lipid deposition & preclinical; moderate \\
PMID\_41475763\_GLM2 & tea; polysaccharides & microbiota-gut-liver axis signaling & butyrate, isovalerate; reduced LDL-C and hepatic lipid deposition & preclinical; moderate \\
PMID\_41861686\_GLM1 & yellow tea; polysaccharides & barrier-related mechanism & SCFAs; intestinal barrier integrity & preclinical; low \\
\bottomrule
\end{tabular}
\end{table}
...
\section{Uncertainty Flag Definitions}
...
\begin{tabular}{p{0.24\linewidth}p{0.31\linewidth}p{0.32\linewidth}p{0.07\linewidth}}
\toprule
